...
<body>
 ...
 <div class="container mt-3">
    <h3><i class="fas fa-edit mt-4"></i>INPUT MAHASISWA</h3>
    <div class="row">
        <div class="col-lg-8">
        <form method="post" action="aksi_add_mahasiswa.php">
            <table>
        ...
        <div class="for-group">
                ...
                <input type="text" name="telepon" class="form-control" placeholder="Masukan No.Telp" required>
        </div>
        <div class="for-group">
